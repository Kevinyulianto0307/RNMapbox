...
//        val defaultLocale = context.applicationContext.inferDeviceLocale()
        ...
        val customColorResources = RouteLineColorResources.Builder()
            .routeDefaultColor(Color.parseColor("#92140C"))
            .routeCasingColor(Color.parseColor("#92140C"))
            .routeLowCongestionColor(Color.parseColor("#92140C"))
            .routeSevereCongestionColor(Color.parseColor("#92140C"))
            .routeUnknownCongestionColor(Color.parseColor("#92140C"))
            .inActiveRouteLegsColor(Color.parseColor("#92140C"))

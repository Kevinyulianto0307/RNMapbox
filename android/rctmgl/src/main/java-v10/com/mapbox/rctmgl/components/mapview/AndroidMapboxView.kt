...
//        val distanceFormatterOptions = mMapboxNavigation!!.navigationOptions.distanceFormatterOptions
        ...
        val customColorResources = RouteLineColorResources.Builder()
            .routeDefaultColor(Color.parseColor("#5E0B15"))
            .routeCasingColor(Color.parseColor("#5E0B15"))
            .routeLowCongestionColor(Color.parseColor("#5E0B15"))
            .routeSevereCongestionColor(Color.parseColor("#5E0B15"))
            .routeUnknownCongestionColor(Color.parseColor("#5E0B15"))
            .inActiveRouteLegsColor(Color.parseColor("#5E0B15"))

...
@interface RCT_EXTERN_REMAP_MODULE(RCTMGLNavigationMapView, RCTMGLNavigationMapViewManager, RCTViewManager)
...
RCT_REMAP_VIEW_PROPERTY(onMapError, reactOnMapError, RCTBubblingEventBlock)
...
RCT_EXTERN_METHOD(stopRoute:(nonnull NSNumber*)reactTag
                  shouldSimulate:(BOOL)shouldSimulate
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject)

RCT_EXTERN_METHOD(resetRoute:(nonnull NSNumber*)reactTag
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject)
